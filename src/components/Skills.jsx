...
export default function Skills() {
  const skills = [
    ...
    { name: "Express.js", icon: <SiExpress className="text-gray-700 w-12 h-12" /> },
    { name: "HTML5", icon: <FaHtml5 className="text-orange-600 w-12 h-12" /> },
    { name: "CSS3", icon: <FaCss3Alt className="text-blue-600 w-12 h-12" /> },
    { name: "Tailwind CSS", icon: <SiTailwindcss className="text-sky-500 w-12 h-12" /> },
    { name: "Bootstrap", icon: <FaBootstrap className="text-purple-600 w-12 h-12" /> },
    ...
    { name: "Postman", icon: <SiPostman className="text-orange-600 w-12 h-12" /> },
    { name: "Chakra UI", icon: <SiChakraui className="text-teal-500 w-12 h-12" /> },
    { name: "WordPress", icon: <FaWordpress className="text-blue-500 w-12 h-12" /> },
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow transition cursor-pointer"
            >
              {skill.icon}
